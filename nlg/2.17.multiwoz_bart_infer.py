"""
======================================================================
2.17.MULTIWOZ_BART_INFER ---

Inference of Bart on multiwoz dataset.
...
def main():
    ...
    model_path=f"./stage1_ckpts/multiwoz_nlg-epoch6-lr5e-5-bs32bart-base/"
    model_path=f"./stage1_ckpts/multiwoz_nlg-epoch6-lr5e-5-bs32bart-base/addQuad1000104019e-50.010.60.70.75finally/"
